...
//deklarasi Prosedur
void shell(int data[], int jumlah_elemen); 
int main()
{
...
void shell(int data[], int jumlah_elemen)
{
    for (int outer = jumlah_elemen/2; outer>0; outer/=2) { // Perulangan luar

        for (int i = outer; i<jumlah_elemen; i+= 1) { // Perulangan dalam
            int temp = data[i];
